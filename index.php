  ...
  <div id="layoutSidenav">
    ...
    <div id="layoutSidenav_content">
              ...
              <div class="card-body">
                ...
                <form method="post" action="masuk.php">
                  ...
                  <div class="form-group row mt-4">
                    <div class="col-3"></div>
                    <div class="col-9">
                      <button class="btn btn-sm btn-primary" name="btnOK" type="submit"> <i class="fa fa-sign-in-alt"></i> Masuk</button>
                    </div>
                  </div>
                </form>
              </div>
      ...
      <footer class="py-4 bg-light mt-auto">
        <div class="container-fluid px-4">
          <div class="d-flex align-items-center justify-content-between small"> <div class="text-muted">&copy; 2022 andre.unigamalang</div> </div>
        </div>
      </footer>
    </div>
  </div>
