            ...
            <table class="table table-sm">
              <thead>
                <tr>
                  <td colspan="7" class="text-end">
                    <a href="frmgurutam.php" class="btn btn-sm btn-primary"> <i class="fa fa-plus"></i> Pengajar Baru</a>
                  </td>
                </tr>
                <tr>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?=$data['alamat']; ?></td>
                  <td><?=$data['noHP']; ?></td>
                  <td class="text-center"><?php if ($data['aktif'] == "y") echo "Ya"; else echo "Tidak"; ?></td>
                  <td class="text-center">
                    <button class="btn py-0" name="btnGurul" value="<?=$data['ID']; ?>"><i class="fas fa-eye"></i> Lihat </button>
                    <button class="btn py-0" name="btnGuruU" value="<?=$data['ID']; ?>"><i class="fa fa-edit"></i> Ubah </button>
                    <button class="btn py-0" name="btnGuruH" value="<?=$data['ID']; ?>"><i class="fa fa-trash-alt"></i> Hapus </button>
                  </td>
                </tr>
                <?php endwhile; ?>
              </tbody>
